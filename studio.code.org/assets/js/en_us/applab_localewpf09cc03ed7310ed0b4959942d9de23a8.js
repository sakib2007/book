...
(window.locales = window.locales || {}).applab_locale = {
  ...
  makerSetupBoardBadResponse: function(d) { return "We found a board but it didn't respond properly when we tried to connect to it."; },
  ...
  makerSetupDownloadAndInstall: function(d) { return "Download and install the Code.org Maker App using the download button above."; },
  ...
  makerSetupInstallFirmata: function(d) { return "You should make sure it has the right firmware sketch installed. You can [install the Firmata sketch with these instructions](" + d.firmataURL + ")."; },
  ...
  makerSetupMakerAppForChromebook: function(d) { return "Maker Toolkit for Chromebook"; },
  makerSetupMakerAppForLinux: function(d) { return "Code.org Maker App for Linux"; },
  makerSetupMakerAppForMac: function(d) { return "Code.org Maker App for Mac"; },
  makerSetupMakerAppForWindows: function(d) { return "Code.org Maker App for Windows"; },
  ...
  makerSetupSerialConnector: function(d) { return "Maker Toolkit on Chromebook does not use the Code.org Maker App. Instead, it depends on the [Code.org Serial Connector](" + d.webstoreURL + ") Chrome App."; },
  makerSetupSignIn: function(d) { return "Open up the Code.org Maker App and sign in to Code.org."; },
